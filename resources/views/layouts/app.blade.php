                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <x-jet-nav-link href="/academics" :active="request()->routeIs('/academics')">
                                    Academics
                                </x-jet-nav-link>
                                <x-jet-nav-link href="/accomodation" :active="request()->routeIs('accomodation')">
                                    Accomodation
                                </x-jet-nav-link>
                                <x-jet-nav-link href="/financials" :active="request()->routeIs('financials')">
                                    Financials
                                </x-jet-nav-link>
